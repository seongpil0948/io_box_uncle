...
//             ? CompanyInfo.fromJson(j['companyInfo'])
//             : null,
//         operInfo = j['operInfo'] == null
//             ? null
//             : j['purchaseMethod'] != null
//                 ? ShopOperInfo.fromJson(j['operInfo'])
//                 : VendorOperInfo.fromJson(j['operInfo']),
//         account =
//             j['account'] == null ? null : AccountInfo.fromJson(j['account']),
...
// enum UserRole { shop, uncle, vendor, uncleWorker }
